...
We know that there isn't perfect multi colinearlity as R would through an error saying it has encountered singularity. However, we can look at the correlation matrix to understand if there is a multi colinearity among the untransformed variables of specification 2.
