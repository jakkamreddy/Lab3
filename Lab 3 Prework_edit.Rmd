...
### Trying to figure out how to increase the height of these facets        - Comment
...
Suspected collinearity between wage variables and tax revenue per capita. Also the more tax per capita, the more money there is to spend on police forces, so police per capita is suspected to be related to tax revenue per capita. Lastly, density could have a confounding effect on per capita variables. Assume we have 2 counties, ceteris paribis, differing only in population density. This means that the per capita measurements for the more densely populated county will be lower than the more sparsely populated county.
